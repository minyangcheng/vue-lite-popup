(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-popup"] = factory();
	else
		root["vue-popup"] = factory();
})(this, function() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_zeptojs__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_zeptojs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_zeptojs__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    show: function show(x, y) {
      __WEBPACK_IMPORTED_MODULE_0_zeptojs___default()(".popup-layer").children().css({ left: x, top: y });
      __WEBPACK_IMPORTED_MODULE_0_zeptojs___default()(".popup-layer").children().click(function (event) {
        event.stopPropagation();
      });
      this.showFlag = true;
    },
    showWithAchor: function showWithAchor(dom, dx, dy) {
      var offsetValue = __WEBPACK_IMPORTED_MODULE_0_zeptojs___default()(dom).offset();
      var left = offsetValue.left + dom.offsetWidth + dx;
      var top = offsetValue.top + dom.offsetHeight + dy;
      this.show(left, top);
    },
    close: function close() {
      this.showFlag = false;
    },
    clickLayer: function clickLayer() {
      this.close();
    }
  },
  watch: {}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Popup_vue__ = __webpack_require__(0);
...
/* harmony default export */ __webpack_exports__["default"] = (Object.assign(iview, { install: install }));
